...
import 'aframe';
import laminate from '../../models/lam.jpg'
import wallpaper from '../../models/floral-retro-70s-wallpaper.jpg'
...
const ExperienceScreen = () => {
  return (
    <a-scene vr-mode-ui="enabled: true">
      ...
      <a-plane position="5.60 1.33 0.22" rotation="0 -90 0" height="2.66" width="6"></a-plane>
      ...
      <a-plane src="#wallpaper" position="2.64 1.33 2.495" rotation="180 0 0" height="2.66" width="6"></a-plane>
